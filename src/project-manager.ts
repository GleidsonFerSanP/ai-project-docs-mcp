...
`;
   ...
   */
  private generateCopilotInstructions(projectId: string, config: ProjectConfig): string {
...
`;
   ...
   */
  generateCopilotInstructionsFile(projectId: string, force: boolean = false): { success: boolean; message?: string; error?: string; file_path?: string } {
